...
原文 [JavaScript engine fundamentals: Shapes and Inline Caches](https://mathiasbynens.be/notes/shapes-ics)，译者 [hijiangtao](https://github.com/hijiangtao)，你也可以在知乎专栏查看[本文](https://zhuanlan.zhihu.com/p/)。以下开始正文。
